...
#define MC_CONFIG_MASS_PRECISION        "mass-precision"
#define MC_CONFIG_ISOTOPIC_BIN_WIDTH    "isotopic-binning-width"
#define MC_CONFIG_ISOTOPIC_BIN_COUNT    "isotopic-max-count"

#define MC_CONFIG_LOCALE_NAME           "locale-name"
